...
def check_architecture():
    ...
    print("  Option A SELECTED: input -> 256 -> 256 -> 2")
    print("\n  Architecture breakdown:")
    print("    - Input layer: variable (depends on dataset)")
    print("    - Hidden layer 1: 256 units")
    print("    - Hidden layer 2: 256 units")
    print("    - Output layer: 2 units (binary classification)")
    print("\n  Rationale:")
    print("    - Matches paper description '3-layer, hidden=256 (>=2x small)'")
